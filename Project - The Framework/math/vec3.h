#pragma once
#include "Project - The Game\SHV\types.h"
#include <cmath>
template<typename T>
class _CVector3 {
public:
	_CVector3(): x(0),y(0),z(0){}
